...
// ClusterQueryConnectorSpec defines the desired state of ClusterQueryConnector.
type ClusterQueryConnectorSpec struct {
	URL           string                    `json:"url"`
...
// ClusterQueryConnectorStatus defines the observed state of ClusterQueryConnector.
type ClusterQueryConnectorStatus struct {
...
type ClusterQueryConnector struct {
	...
	Spec   ClusterQueryConnectorSpec   `json:"spec,omitempty"`
	Status ClusterQueryConnectorStatus `json:"status,omitempty"`
}
